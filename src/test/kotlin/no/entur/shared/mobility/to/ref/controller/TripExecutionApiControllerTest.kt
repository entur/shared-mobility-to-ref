...
import no.entur.shared.mobility.to.ref.tomp150.controller.TripExecutionApiController
...
class TripExecutionApiControllerTest {
    @Autowired
    private lateinit var legsController: TripExecutionApiController
