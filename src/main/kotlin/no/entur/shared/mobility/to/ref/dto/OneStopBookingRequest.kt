 ...
 * Id's are agreed upon by TO and MP.
...
data class OneStopBookingRequest(
    ...
    @Schema(
        example = "null",
        description =
            "instead of using the from/to construct, it is also possible to give an indication of the distance to travel. The " +
    ...
    @Schema(
        example = "null",
        description =
            "The intended departure time. If left out and no arrivalTime is set, the current time should be assumed. If only " +
    ...
    @Schema(
        example = "null",
        description =
            "The intended arrival time, at the `to place`. If not set, the time the user intends to stop using the asset " +
    ...
    @Schema(
        example = "null",
        description =
            "Extra information about the people that intend to travel if relevant, length must be less than or equal to " +
                "nrOftravelers.",
    )
    ...
    @Schema(
        example = "null",
        description =
            "Id(s) of user groups that the user belongs to. This provides access to exclusive assets that are hidden to the " +
