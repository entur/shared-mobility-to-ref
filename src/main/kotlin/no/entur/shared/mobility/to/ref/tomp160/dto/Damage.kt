 ...
 * @param vehicleComponentName a short term to describe the damaged part
...
data class Damage(
    ...
    @Schema(example = "null", description = "a short term to describe the damaged part")
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): VehicleComponent {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'VehicleComponent'")
            }
        }
    }
