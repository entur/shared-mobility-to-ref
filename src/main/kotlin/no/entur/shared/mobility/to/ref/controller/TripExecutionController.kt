...
@RestController("no.entur.shared.mobility.to.ref.controller.TripExecutionController")
@Validated
@RequestMapping("\${api.base-path:/bike}")
class TripExecutionController(
    @Autowired(required = true) val service: TripExecutionService,
) {
    @Operation(
        summary = "",
    ...
    fun legsIdAncillariesCategoryNumberDelete(
        ...
        @Parameter(description = "ancillary category", required = true) @PathVariable("category") category: kotlin.String,
        @Parameter(description = "ancillary number", required = true) @PathVariable("number") number: kotlin.String,
        @Parameter(
        ...
        ResponseEntity(
            service.legsIdAncillariesCategoryNumberDelete(acceptLanguage, api, apiVersion, maasId, id, category, number, addressedTo),
    ...
    fun legsIdAncillariesCategoryNumberPost(
        ...
        ResponseEntity(
            service.legsIdAncillariesCategoryNumberPost(acceptLanguage, api, apiVersion, maasId, id, category, number, addressedTo),
            HttpStatus.valueOf(200),
        )
    ...
    @Operation(
        ...
        responses = [
            ApiResponse(
                responseCode = "200",
                description = "operation successful",
                content = [Content(schema = Schema(implementation = kotlin.Boolean::class))],
            ),
            ApiResponse(
                responseCode = "401",
                description = "Although the HTTP standard specifies \"unauthorized\", semantically this response means \"unauthenticated\". That is, the client must authenticate itself to get the requested response.",
    ...
    fun legsIdConfirmationPost(
        ...
        ResponseEntity(service.legsIdConfirmationPost(acceptLanguage, api, apiVersion, id, confirmationRequest), HttpStatus.valueOf(200))
    ...
    fun legsIdGet(
        ...
        ResponseEntity(service.legsIdGet(acceptLanguage, api, apiVersion, maasId, id, addressedTo), HttpStatus.valueOf(200))
    ...
    fun legsIdProgressGet(
        ...
        ) @Valid @RequestParam(value = "location-only", required = false, defaultValue = "false") locationOnly: kotlin.Boolean,
    ...
    fun legsIdPut(
        ...
        ResponseEntity(service.legsIdPut(acceptLanguage, api, apiVersion, maasId, id, leg, addressedTo), HttpStatus.valueOf(204))
}
