...
@RestController("no.entur.shared.mobility.to.ref.controller.PlanningController")
@Validated
@RequestMapping("\${api.base-path:/bike}")
class PlanningController(
    @Autowired(required = true) val service: PlanningService,
) {
    @Operation(
        summary = "",
    ...
    fun bookingsOneStopPost(
        ...
        ResponseEntity(
            service.bookingsOneStopPost(acceptLanguage, api, apiVersion, maasId, addressedTo, oneStopBookingRequest),
    ...
    fun planningInquiriesPost(
        ...
        ResponseEntity(
            service.planningInquiriesPost(acceptLanguage, api, apiVersion, maasId, addressedTo, planningRequest),
            HttpStatus.valueOf(201),
        )
    ...
    fun planningOffersPost(
        ...
        ResponseEntity(
            service.planningOffersPost(acceptLanguage, api, apiVersion, maasId, addressedTo, planningRequest),
            HttpStatus.valueOf(201),
        )
    ...
    fun planningsPost(
        ...
        ) @Valid @RequestParam(value = "booking-intent", required = false, defaultValue = "false") bookingIntent: kotlin.Boolean,
        @Parameter(description = "") @Valid @RequestBody(required = false) planningRequest: PlanningRequest?,
    ): ResponseEntity<Planning> =
        ResponseEntity(
            service.planningsPost(acceptLanguage, api, apiVersion, maasId, addressedTo, bookingIntent, planningRequest),
            HttpStatus.valueOf(201),
        )
}
