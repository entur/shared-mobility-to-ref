...
import no.entur.shared.mobility.to.ref.tomp160.dto.AssetAccessMethods
import no.entur.shared.mobility.to.ref.tomp160.dto.AssetPropertiesEcoLabelInner
...
data class AssetProperties(
    ...
    @field:Valid
    @Schema(example = "null", description = "access method for trip execution. Data will be delivered in the response of /booking/{id}/events - COMMIT or /leg/{id}/events - PREPARE (preferred) or GET /bookings/{id}.")
    ...
    @field:Valid
    @Schema(example = "null", description = "this object can contain extra information about the type of asset. For instance values from the 'Woordenboek Reizigerskenmerken'. [https://github.com/efel85/TOMP-API/issues/17]. These values can also be used in the planning.")
