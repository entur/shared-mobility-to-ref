...
import no.entur.shared.mobility.to.ref.tomp200.dto.GeojsonCollectionProperties
import no.entur.shared.mobility.to.ref.tomp200.dto.GeojsonFeature
...
data class Geojson(
    ...
    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("features") val features: kotlin.collections.List<GeojsonFeature>? = null,

    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("properties") val properties: GeojsonCollectionProperties? = null,
