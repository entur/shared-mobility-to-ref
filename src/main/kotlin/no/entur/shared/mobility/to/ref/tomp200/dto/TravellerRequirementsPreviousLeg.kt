 ...
 * @param &#x60;operator&#x60; default string, full names etc (length 0-200)
 ...
 */
data class TravellerRequirementsPreviousLeg(
    ...
    @get:Size(max=200)
    @Schema(example = "null", description = "default string, full names etc (length 0-200)")
    @get:JsonProperty("asset") val asset: kotlin.String? = null
) {
