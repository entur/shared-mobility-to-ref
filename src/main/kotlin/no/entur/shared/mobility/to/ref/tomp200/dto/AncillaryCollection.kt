...
import no.entur.shared.mobility.to.ref.tomp200.dto.AncillaryCollectionFeaturesInner
import no.entur.shared.mobility.to.ref.tomp200.dto.AncillaryCollectionProperties
 ...
 */
data class AncillaryCollection(
    ...
    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("features") val features: kotlin.collections.List<AncillaryCollectionFeaturesInner>? = null,

    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("properties") val properties: AncillaryCollectionProperties? = null,
