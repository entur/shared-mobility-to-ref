...
import no.entur.shared.mobility.to.ref.tomp200.dto.GeojsonFeatureProperties
...
data class GeojsonFeature(
    ...
    @field:Valid
    @Schema(example = "null", required = true, description = "")
    @get:JsonProperty("properties", required = true) val properties: GeojsonFeatureProperties,
