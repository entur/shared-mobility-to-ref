...
interface OfferService {
     ...
     * @see Offer#requestOffer
     */
    fun requestOffer(acceptLanguage: kotlin.String, authorization: kotlin.String, offerId: kotlin.String): Package
     ...
     *         or Bad request. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for further explanation of error code. (status code 200)
     * @see Offer#searchOffers
     */
    fun searchOffers(acceptLanguage: kotlin.String, authorization: kotlin.String, limit: kotlin.Int, offset: kotlin.Int, bbox: kotlin.collections.List<java.math.BigDecimal>?, searchOffersRequest: SearchOffersRequest?): OfferCollection
}
