...
import no.entur.shared.mobility.to.ref.tomp200.dto.AssetCollectionFeaturesInner
import no.entur.shared.mobility.to.ref.tomp200.dto.AssetCollectionProperties
...
data class AssetCollection(
    ...
    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("features") val features: kotlin.collections.List<AssetCollectionFeaturesInner>? = null,

    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("properties") val properties: AssetCollectionProperties? = null,
