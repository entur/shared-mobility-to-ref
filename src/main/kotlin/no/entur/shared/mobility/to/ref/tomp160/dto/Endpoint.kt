...
data class Endpoint(
    ...
    @Schema(example = "null", description = "this field must be used when adressing other standards for exchanging 'static' data (Level 1 MaaS)")
    ...
    * Values: GBFS,GTFS,NE_TEX,OSDM_OFFLINE,IXSI5,APDS,CDS
    */
