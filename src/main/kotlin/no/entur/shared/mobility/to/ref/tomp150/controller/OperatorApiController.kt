...
class OperatorApiController {
    ...
    ): ResponseEntity<List<SystemAlert>> = ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    ...
    ): ResponseEntity<List<AssetType>> = ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    ...
    ): ResponseEntity<SystemInformation> = ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    ...
    ): ResponseEntity<List<EndpointImplementation>> = ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    ...
    ): ResponseEntity<List<SystemCalendar>> = ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    ...
    ): ResponseEntity<List<SystemHours>> = ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    ...
    ): ResponseEntity<List<SystemPricingPlan>> = ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    ...
    fun operatorRegionsGet(
        ...
        @Min(0)@Parameter(description = "count of the selection") @Valid @RequestParam(value = "limit", required = false) limit:
            kotlin.Int?,
    ): ResponseEntity<List<SystemRegion>> = ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    ...
    ): ResponseEntity<List<StationInformation>> = ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
