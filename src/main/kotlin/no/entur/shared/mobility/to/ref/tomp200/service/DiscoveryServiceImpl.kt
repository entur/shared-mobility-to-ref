...
import no.entur.shared.mobility.to.ref.tomp200.controller.DiscoveryService
...
@Service("DiscoveryServiceImpl200")
class DiscoveryServiceImpl : DiscoveryService {
     ...
     */
    override fun describeCollection(collectionId: String): Collection {
     ...
     *         or Bad request. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for further explanation of error code. (status code 200)
     */
    override fun getCollections(): Collections {
        TODO("Not yet implemented")
    }
     ...
     *         or Bad request. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for further explanation of error code. (status code 200)
     */
    override fun getConformanceDeclaration(f: String): Conformance {
        TODO("Not yet implemented")
    }
     ...
     *         or Bad request. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for further explanation of error code. (status code 200)
     */
    override fun getProcessDescription(processID: String): Process {
        TODO("Not yet implemented")
    }
     ...
     *         or Bad request. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for further explanation of error code. (status code 200)
     */
    override fun getProcesses(): ProcessList {
        TODO("Not yet implemented")
    }
     ...
     */
    override fun landingPage(f: String): LandingPage {
        TODO("Not yet implemented")
    }
