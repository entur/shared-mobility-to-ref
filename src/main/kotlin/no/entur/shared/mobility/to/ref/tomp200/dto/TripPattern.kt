...
data class TripPattern(
    ...
    @get:Pattern(regexp="^(tripPattern)$")
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("serviceJourneys") val serviceJourneys: kotlin.collections.List<kotlin.String>? = null,

    @Schema(example = "null", description = "https://www.rfc-editor.org/rfc/rfc3339#section-5.6, full-date (2019-10-12)")
    @get:JsonProperty("travelDate") val travelDate: kotlin.String? = null
) {
