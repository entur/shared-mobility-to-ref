 ...
 * conitions, etc. that the publisher would like users to see. This is intended to be a human-readable description and should not be used
...
data class SystemPricingPlan(
    ...
    @Schema(
        ...
        required = true,
        description =
            "false indicates that no additional tax will be added (either because tax is not charged, or because it is " +
    ...
    @Schema(
        ...
        required = true,
        description =
            "Text field describing the particular pricing plan in human readable terms. This should include the duration, " +
                "price, conditions, etc. that the publisher would like users to see. This is intended to be a human-readable " +
                "description and should not be used for automatic calculations, should match Content-Language",
    )
    ...
    @Schema(
        example = "null",
        description =
            "Is there currently an increase in price in response to increased demand in this pricing plan? If this field is " +
                "empty, it means there is no surge pricing in effect.",
    )
