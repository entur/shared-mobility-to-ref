...
import no.entur.shared.mobility.to.ref.tomp200.dto.TravelDocument
 ...
 * @param links 
 */
data class TravelDocumentsFeaturesInner(
    ...
    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("properties") val properties: TravelDocument? = null,
