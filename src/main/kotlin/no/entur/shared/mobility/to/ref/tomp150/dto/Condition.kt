...
@JsonIgnoreProperties(
  value = ["conditionType"], // ignore manually set conditionType, it will be automatically generated by Jackson during serialization
  allowSetters = true // allows the conditionType to be set during deserialization
)
