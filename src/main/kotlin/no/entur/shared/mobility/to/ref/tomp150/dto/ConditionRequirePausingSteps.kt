 ...
 */
data class ConditionRequirePausingSteps(

    @field:Valid
    @Schema(required = true, description = "")
    @param:JsonProperty("steps", required = true)
    @get:JsonProperty("steps", required = true) val steps: kotlin.collections.List<PausingStep>,

    @Schema(required = true, description = "The specific subclass of condition, should match the schema name exactly")
    @param:JsonProperty("conditionType", required = true)
