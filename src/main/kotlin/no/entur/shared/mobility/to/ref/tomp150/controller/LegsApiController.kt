...
class LegsApiController {
    ...
    ): ResponseEntity<Leg> = ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    ...
    fun legsIdAvailableAssetsGet(
        ...
        @Min(0)@Parameter(description = "count of the selection") @Valid @RequestParam(value = "limit", required = false) limit:
            kotlin.Int?,
    ): ResponseEntity<List<Asset>> = ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    ...
    ): ResponseEntity<kotlin.Boolean> = ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    ...
    ): ResponseEntity<LegProgress> = ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
