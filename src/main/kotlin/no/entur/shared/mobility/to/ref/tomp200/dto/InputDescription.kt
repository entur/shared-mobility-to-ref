...
import no.entur.shared.mobility.to.ref.tomp200.dto.InputDescriptionAllOfMaxOccurs
...
data class InputDescription(
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("minOccurs") val minOccurs: kotlin.Int? = 1,

    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("maxOccurs") val maxOccurs: InputDescriptionAllOfMaxOccurs? = null
) {
