...
@RestController("no.entur.shared.mobility.to.ref.tomp160.controller.SupportController")
@Validated
...
class SupportController(@Autowired(required = true) val service: SupportService) {
    ...
    fun supportPost(
        ...
        return ResponseEntity(
            service.supportPost(acceptLanguage, api, apiVersion, maasId, addressedTo, supportRequest),
