...
interface PreSalesService {
     ...
     * @see PreSales#assignAncillaryRequest
     */
    fun assignAncillaryRequest(acceptLanguage: kotlin.String, authorization: kotlin.String, assignAncillaryRequestRequest: AssignAncillaryRequestRequest?): Package
     ...
     * @return a single instance of a package (status code 200)
     *         or Bad request. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for further explanation of error code. (status code 200)
     * @see PreSales#assignAssetRequest
     */
    fun assignAssetRequest(acceptLanguage: kotlin.String, authorization: kotlin.String, assignAssetRequestRequest: AssignAssetRequestRequest?): Package
     ...
     * @return a single instance of a package (status code 200)
     *         or Bad request. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for further explanation of error code. (status code 200)
     * @see PreSales#releasePackageRequest
     */
    fun releasePackageRequest(acceptLanguage: kotlin.String, authorization: kotlin.String, releasePackageRequestRequest: ReleasePackageRequestRequest?): Package
     ...
     * @return a single instance of a package (status code 200)
     *         or Bad request. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for further explanation of error code. (status code 200)
     * @see PreSales#removeOfferRequest
     */
    fun removeOfferRequest(acceptLanguage: kotlin.String, authorization: kotlin.String, removeOfferRequestRequest: RemoveOfferRequestRequest?): Package
     ...
     *         or Bad request. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for further explanation of error code. (status code 200)
     * @see PreSales#requestAncillaries
     */
    fun requestAncillaries(acceptLanguage: kotlin.String, authorization: kotlin.String, packageId: kotlin.String, legId: kotlin.String, limit: kotlin.Int, offset: kotlin.Int, bbox: kotlin.collections.List<java.math.BigDecimal>?): AncillaryCollection
     ...
     *         or Bad request. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for further explanation of error code. (status code 200)
     * @see PreSales#requestAssets
     */
    fun requestAssets(acceptLanguage: kotlin.String, authorization: kotlin.String, packageId: kotlin.String, legId: kotlin.String, limit: kotlin.Int, offset: kotlin.Int, bbox: kotlin.collections.List<java.math.BigDecimal>?): AssetCollection
     ...
     * @return a single instance of a package (status code 200)
     *         or Bad request. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for further explanation of error code. (status code 200)
     * @see PreSales#selectOffersRequest
     */
    fun selectOffersRequest(acceptLanguage: kotlin.String, authorization: kotlin.String, selectOffersRequestRequest: SelectOffersRequestRequest?): Package
     ...
     * @return a single instance of a package (status code 200)
     *         or Bad request. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for further explanation of error code. (status code 200)
     * @see PreSales#updateTravelSpecificationRequest
     */
    fun updateTravelSpecificationRequest(acceptLanguage: kotlin.String, authorization: kotlin.String, updateTravelSpecificationRequestRequest: UpdateTravelSpecificationRequestRequest?): Package
     ...
     * @return a single instance of a package (status code 200)
     *         or Bad request. See https://github.com/TOMP-WG/TOMP-API/wiki/Error-handling-in-TOMP for further explanation of error code. (status code 200)
     * @see PreSales#updateTravellerRequest
     */
    fun updateTravellerRequest(acceptLanguage: kotlin.String, authorization: kotlin.String, updateTravellerRequestRequest: UpdateTravellerRequestRequest?): Package
}
