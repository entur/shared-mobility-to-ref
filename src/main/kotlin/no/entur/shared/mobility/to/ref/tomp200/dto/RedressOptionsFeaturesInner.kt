...
import no.entur.shared.mobility.to.ref.tomp200.dto.RedressOption
 ...
 * @param links 
 */
data class RedressOptionsFeaturesInner(
    ...
    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("properties") val properties: RedressOption? = null,
