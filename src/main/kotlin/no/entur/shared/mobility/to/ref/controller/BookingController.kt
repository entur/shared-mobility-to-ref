...
@RestController("no.entur.shared.mobility.to.ref.controller.BookingController")
@Validated
@RequestMapping("\${api.base-path:/bike}")
class BookingController(
    @Autowired(required = true) val service: BookingService,
) {
    @Operation(
        summary = "",
    ...
    fun bookingsIdGet(
        ...
        ResponseEntity(service.bookingsIdGet(acceptLanguage, api, apiVersion, maasId, id, addressedTo), HttpStatus.valueOf(200))
    ...
    fun bookingsPost(
        ...
        ResponseEntity(service.bookingsPost(acceptLanguage, api, apiVersion, maasId, bookingRequest, addressedTo), HttpStatus.valueOf(201))
}
