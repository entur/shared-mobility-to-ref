...
data class SystemAlert(
    ...
    @get:JsonProperty(
        "startAndEndTimes",
    ) val startAndEndTimes: kotlin.collections.List<kotlin.collections.List<java.time.OffsetDateTime>>? =
        null,
    @Schema(
    ...
    enum class AlertType(
        ...
        companion object {
            @JvmStatic
            @JsonCreator
            fun forValue(value: kotlin.String): AlertType = values().first { it -> it.value == value }
        }
    }
}
