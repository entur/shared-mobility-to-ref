...
data class FarePart(
    ...
    enum class UnitType(
        ...
        companion object {
            @JvmStatic
            @JsonCreator
            fun forValue(value: kotlin.String): UnitType = values().first { it -> it.value == value }
        }
    }
    ...
    enum class ScaleType(
        ...
        companion object {
            @JvmStatic
            @JsonCreator
            fun forValue(value: kotlin.String): ScaleType = values().first { it -> it.value == value }
        }
    }
    ...
    enum class PropertyClass(
        ...
        companion object {
            @JvmStatic
            @JsonCreator
            fun forValue(value: kotlin.String): PropertyClass = values().first { it -> it.value == value }
        }
    }
    ...
    enum class AssetState(
        ...
        companion object {
            @JvmStatic
            @JsonCreator
            fun forValue(value: kotlin.String): AssetState = values().first { it -> it.value == value }
        }
    }
}
