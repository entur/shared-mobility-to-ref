...
data class StationInformation(
    ...
    enum class ParkingType(
        ...
        companion object {
            @JvmStatic
            @JsonCreator
            fun forValue(value: kotlin.String): ParkingType = values().first { it -> it.value == value }
        }
    }
    ...
    enum class RentalMethods(
        ...
        companion object {
            @JvmStatic
            @JsonCreator
            fun forValue(value: kotlin.String): RentalMethods = values().first { it -> it.value == value }
        }
    }
}
