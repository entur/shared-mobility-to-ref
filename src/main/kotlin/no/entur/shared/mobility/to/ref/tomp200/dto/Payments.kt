...
import no.entur.shared.mobility.to.ref.tomp200.dto.PaymentsFeaturesInner
import no.entur.shared.mobility.to.ref.tomp200.dto.PaymentsProperties
...
data class Payments(
    ...
    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("features") val features: kotlin.collections.List<PaymentsFeaturesInner>? = null,

    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("properties") val properties: PaymentsProperties? = null,
