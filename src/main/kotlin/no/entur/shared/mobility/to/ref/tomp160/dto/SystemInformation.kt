...
import no.entur.shared.mobility.to.ref.tomp160.dto.ChamberOfCommerceInfo
...
data class SystemInformation(
    ...
    @param:JsonProperty("systemId", required = true)
    ...
    @param:JsonProperty("language", required = true)
    ...
    @param:JsonProperty("timezone", required = true)
    ...
    @param:JsonProperty("typeOfSystem", required = true)
    ...
    @param:JsonProperty("purchaseUrl")
    ...
    @param:JsonProperty("storeUriAndroid")
    ...
    @param:JsonProperty("storeUriIOS")
    ...
    @param:JsonProperty("feedContactEmail")
    ...
    @param:JsonProperty("licenseUrl")
    @get:JsonProperty("licenseUrl") val licenseUrl: kotlin.String? = null,

    @field:Valid
    @Schema(description = "")
    @param:JsonProperty("chamberOfCommerceInfo")
    ...
    */
    enum class TypeOfSystem(@get:JsonValue val value: kotlin.String) {
