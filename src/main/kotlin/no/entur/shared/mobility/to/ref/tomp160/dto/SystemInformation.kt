...
data class SystemInformation(
    ...
    @Schema(example = "null", required = true, description = "The languages supported by this operator for user-facing text. These can be requested using the Accept-Language header and should then be returned in Content-Language")
    ...
    @Schema(example = "null", description = "Added to include possibility to communicatie general rental conditions like minimum age, max. reservation time etc. [amended]")
