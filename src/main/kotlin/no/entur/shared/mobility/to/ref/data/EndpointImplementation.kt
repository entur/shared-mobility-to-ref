        ...
        EndpointImplementation(
            ...
            endpoints =
                listOf(
                    ...
                    Endpoint(method = POST, path = EndpointType.BOOKINGS_ONE_STOP_POST.path, status = Status.IMPLEMENTED),
                    Endpoint(method = POST, path = EndpointType.LEGS_ID_EVENTS_POST.path, status = Status.IMPLEMENTED),
                    Endpoint(method = POST, path = EndpointType.LEGS_ID_EVENTS_POST.path, status = Status.IMPLEMENTED, eventType = EventType.SET_IN_USE),
                    Endpoint(method = POST, path = EndpointType.LEGS_ID_EVENTS_POST.path, status = Status.IMPLEMENTED, eventType = EventType.PAUSE),
                    Endpoint(method = POST, path = EndpointType.LEGS_ID_EVENTS_POST.path, status = Status.IMPLEMENTED, eventType = EventType.START_FINISHING),
                    Endpoint(method = POST, path = EndpointType.LEGS_ID_EVENTS_POST.path, status = Status.IMPLEMENTED, eventType = EventType.FINISH),
                    Endpoint(method = POST, path = EndpointType.LEGS_ID_EVENTS_POST.path, status = Status.IMPLEMENTED, eventType = EventType.CANCEL),
                    Endpoint(method = GET, path = EndpointType.LEGS_ID_GET.path, status = Status.IMPLEMENTED),
                    Endpoint(method = GET, path = EndpointType.OPERATOR_META_GET.path, status = Status.IMPLEMENTED),
                    Endpoint(method = GET, path = EndpointType.PAYMENT_JOURNAL_ENTRY_GET.path, status = Status.IMPLEMENTED),
                ),
